...
`index.html` 의 `:root` 값만 조정. `assets/origin/door-4.png` 를 위 130 / 아래 54 잘라낸 800×1160 기준 백분율 — 자르는 양은 `tools/build-assets.mjs` 의 `CUT_TOP`·`CUT_BOT`, 잘라낸 뒤 값은 그 스크립트가 출력한다.
